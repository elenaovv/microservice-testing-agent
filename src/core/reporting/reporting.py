...
Heavy analysis helpers live in:
  - core.coverage.coverage_utils       - MSA spec parsing and endpoint/service inference
  - core.analysis.inference            - code and failure analysis
  - core.evaluation.evaluation_rendering - evaluation summary markdown rendering
  - core.reporting.report_rendering    - execution-report and journey-guide rendering
"""

import json
from pathlib import Path

from core.execution.run_artifacts import GENERATED_TESTS_DIR, TEST_RESULTS_DIR
...
from core.evaluation.evaluation_utils import build_phase1_metrics, load_network_capture
from core.contracts.journey_contract import build_journey_contract
from core.reporting.report_rendering import render_journey_guide
